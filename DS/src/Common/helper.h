...
#define TEST_TYPE(name)				ns_Util::Logger::LOG_MSG("TEST : ", name, __LINE__, '\n')
#define TEST_PASS(name)				ns_Util::Logger::LOG_MSG("TEST PASSED : ", name, __LINE__, '\n')
#define TEST_FAIL(name)				ns_Util::Logger::LOG_MSG("TEST FAILED : ", name, __LINE__, '\n')
#define TEST_FAIL_MSG(name, msg)	ns_Util::Logger::LOG_MSG("TEST FAILED : ", name, __LINE__, " :: ", msg, '\n')
